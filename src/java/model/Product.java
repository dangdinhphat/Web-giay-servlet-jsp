...
public class Product {
    ...
    public Product(int id, String name, String description, double price, String status, int brandId, String imageUrl) {
        this(id, name, description, price, status, imageUrl);
    ...
    public String toString() {
        return "Product{" + "id=" + id + ", name=" + name + ", description=" + description + ", price=" + price + ", status=" + status + ", brandId=" + brandId + ", imageUrl=" + imageUrl + '}';
    }
}
