...
public class OrderHistoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Gọi DAO lấy danh sách đơn hàng dựa vào ID người dùng
        OrderDAO orderDao = new OrderDAO();
        List<model.Order> orderList = orderDao.getOrdersByUserId(acc.getId());
        
        // Đẩy danh sách đơn hàng sang giao diện JSP
        request.setAttribute("historyData", orderList);
